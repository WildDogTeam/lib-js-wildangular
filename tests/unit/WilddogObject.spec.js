describe('$wilddogObject', function() {
  'use strict';
  var $wilddogObject, $utils, $rootScope, $timeout, obj, testutils, $interval, log;
  ...
  beforeEach(function () {
    ...
    inject(function (_$interval_, _$wilddogObject_, _$timeout_, $wilddogUtils, _$rootScope_, _testutils_) {
      $wilddogObject = _$wilddogObject_;
      $timeout = _$timeout_;
  ...
  describe('$save', function () {
    it('should call $wilddog.$set', function () {
      spyOn(obj.$ref(), 'set');
      obj.foo = 'bar';
      obj.$save();
  ...
  describe('$loaded', function () {
    ...
    it('should resolve to the WilddogObject instance', function () {
  ...
  describe('$ref', function () {
    it('should return the Wilddog instance that created it', function () {
      var ref = stubRef();
  ...
  describe('$bindTo', function () {
    ...
    it('should send local changes to $wilddog.$set', function () {
      spyOn(obj.$ref(), 'set');
      var $scope = $rootScope.$new();
  ...
  describe('$remove', function() {
    ...
    it('should call remove on the Wilddog ref', function() {
  ...
  describe('$destroy', function () {
    it('should call off on Wilddog ref', function () {
  ...
  describe('$extend', function () {
    ...
    it('should return child class', function () {
      function A() {}
      var res = $wilddogObject.$extend(A);
      expect(res).toBe(A);
    });

    it('should be instanceof $wilddogObject', function () {
      function A() {}
      $wilddogObject.$extend(A);
      expect(new A(stubRef())).toBeInstanceOf($wilddogObject);
    });
    ...
    it('should add on methods passed into function', function () {
      ...
      var F = $wilddogObject.$extend({foo: foo});
      var res = F(stubRef());
    ...
    it('should work with the new keyword', function() {
      var fn = function() {};
      var Res = $wilddogObject.$extend({foo: fn});
  ...
  function stubRef() {
    return new MockWilddog('Mock://').child('data').child(DEFAULT_ID);
  }
