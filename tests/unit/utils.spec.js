'use strict';
describe('$wilddogUtils', function () {
  ...
  beforeEach(function () {
    module('wilddog');
    module('testutils');
    inject(function (_$wilddogUtils_, _$timeout_, _testutils_) {
      $utils = _$wilddogUtils_;
      $timeout = _$timeout_;
  ...
  describe('#doSet', function() {
    var ref;
    beforeEach(function() {
      ref = new MockWilddog('Mock://').child('data/REC1');
    });
    ...
    it('only affects query keys when using a query', function() {
      ref.set(MOCK_DATA);
      ref.flush();
      var query = ref.limit(1); //todo-mock MockWilddog doesn't support 2.x queries yet
  ...
  describe('#doRemove', function() {
    ...
    it('only removes keys in query when query is used', function() {
      ref.set(MOCK_DATA);
      ref.flush();
      var query = ref.limit(2); //todo-mock MockWilddog does not support 2.x queries yet
...
describe('#promise (ES6 Polyfill)', function(){
  ...
  beforeEach(module('wilddog',function($provide){
  ...
  beforeEach(inject(function(_$wilddogUtils_, _$timeout_){
    $utils = _$wilddogUtils_;
    $timeout = _$timeout_;
  }));
