...
beforeEach(function() {
  ...
  jasmine.addMatchers({
    toBeAWilddogRef: function() {
      return {
        compare: function(actual) {
          var type = extendedTypeOf(actual);
          var pass = isWilddogRef(actual);
          var notText = pass? ' not' : '';
          var msg = 'Expected ' + type + notText + ' to be a Wilddog ref';
    ...
    toBeASnapshot: function() {
      return {
        compare: function(actual) {
          ...
          var notText = pass? ' not' : '';
          var msg = 'Expected ' + type + notText + ' to be a Wilddog snapshot';
          return {pass: pass, message: msg};
        }
      }
    },
